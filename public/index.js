...
const getClientCredentialsToken = () => __awaiter(this, void 0, void 0, function* () {
    ...
    try {
        ...
        console.error("Failed to get token:", yield response.text());
    }
    catch (error) {
...
function fetchExistingCMSItems() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        do {
            ...
            try {
                const response = yield fetch(cmsItemsUrl, options);
                const data = yield response.json();
                ///checking for error
                if (!response.ok) {
...
function fetchDataWithOAuth2(access_token) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const cmsItems = yield fetchExistingCMSItems();
            ...
            const fullIceItem = iceData.map((eachData, i) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (!itemExists) {
                    ...
                    const newData = yield fetch(`https://api.iceportal.com/v1/listings/${listingID}/assets?includeDisabledAssets=false&includeNotApprovedAssets=false
        `, { method: "GET", headers: headers });
                    const newDataItems = yield newData.json();
...
(() => __awaiter(this, void 0, void 0, function* () {
    const token = yield getClientCredentialsToken();
    if (token) {
        console.log(`Received token: ${token}`);
        yield fetchDataWithOAuth2(token);
    }
}))();
